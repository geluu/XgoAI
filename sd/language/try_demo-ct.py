...
CATEGORY_ITEMS_DICT = {
	...
	"basics": (33, 3, 174, 30, 41, 8, '基礎', "/sd/preset/images/icon_basics.jpg"),
	"vision": (33, 3, 174, 30, 41, 8, '視覺', "/sd/preset/images/icon_vision.jpg"),
	"ml": (33, 3, 174, 30, 41, 10, '人工智慧', "/sd/preset/images/icon_ml.jpg"),
	"audiovideo": (33, 3, 174, 30, 41, 8, '多媒體       ', "/sd/preset/images/icon_av.jpg")
}
...
MENU_ITEMS = [
	# Basics
	("迷你照相機", CATEGORY_ITEMS_DICT["basics"], MENU_ITEM_PARENT_PATH + "demo_mini_camera" + ".py"), 
	("相機照片瀏覽器",CATEGORY_ITEMS_DICT["basics"], MENU_ITEM_PARENT_PATH + "demo_camera_shot_browser" + ".py"), 
	("按鍵控制時針轉動",CATEGORY_ITEMS_DICT["basics"], MENU_ITEM_PARENT_PATH + "demo_button_rotate_clock" + ".py"), 
	("按鍵控制顏色變化",CATEGORY_ITEMS_DICT["basics"], MENU_ITEM_PARENT_PATH + "demo_button_switch_color" + ".py"), 
	("簡易線條動畫",CATEGORY_ITEMS_DICT["basics"], MENU_ITEM_PARENT_PATH + "demo_lcd_drawing_demo" + ".py"), 
	("按鍵隨機生成蒙德里安  ",CATEGORY_ITEMS_DICT["basics"], MENU_ITEM_PARENT_PATH + "demo_generative_mondrian" + ".py"), 
	("按鍵控制螢幕轉動",CATEGORY_ITEMS_DICT["basics"], MENU_ITEM_PARENT_PATH + "demo_screen_rotation" + ".py"), 
	("按鍵控制圖片尺寸調整   ",CATEGORY_ITEMS_DICT["basics"], MENU_ITEM_PARENT_PATH + "demo_button_resize" + ".py"), 
	("漢字文字顯示",CATEGORY_ITEMS_DICT["basics"], MENU_ITEM_PARENT_PATH + "demo_cjk-test" + ".py"), 
	# Machine Learning
	("圖片資料採集器", CATEGORY_ITEMS_DICT["ml"], MENU_ITEM_PARENT_PATH + "demo_training_set_collector" + ".py"), 
	("人臉追蹤",  CATEGORY_ITEMS_DICT["ml"], MENU_ITEM_PARENT_PATH + "demo_face_recognition" + ".py"), 
	("物體追蹤", CATEGORY_ITEMS_DICT["ml"], MENU_ITEM_PARENT_PATH + "demo_object_recognition" + ".py"), 
	("可可標誌識別", CATEGORY_ITEMS_DICT["ml"], MENU_ITEM_PARENT_PATH + "demo_coco_logo_recognition" + ".py"), 
	("手寫數字識別  ", CATEGORY_ITEMS_DICT["ml"], MENU_ITEM_PARENT_PATH + "demo_handwritten_digit_recognition" + ".py"), 
	("自定義垃圾分類識別", CATEGORY_ITEMS_DICT["ml"], MENU_ITEM_PARENT_PATH + "demo_hongkong_trash_classification" + ".py"), 
	# ("HK Road Sign Recognition", CATEGORY_ITEMS_DICT["ml"], MENU_ITEM_PARENT_PATH + "demo_hongkong_trash_classification" + ".py"), 
	("人臉辨識", CATEGORY_ITEMS_DICT["ml"], MENU_ITEM_PARENT_PATH + "demo_face-compare" + ".py"), 
	("物體分類器", CATEGORY_ITEMS_DICT["ml"], MENU_ITEM_PARENT_PATH + "demo_object-classifier" + ".py"), 
	# Machine Vision
	("雙線監測", CATEGORY_ITEMS_DICT["vision"], MENU_ITEM_PARENT_PATH + "demo_double_line_detection" + ".py"), 
	("單線監測", CATEGORY_ITEMS_DICT["vision"], MENU_ITEM_PARENT_PATH + "demo_single_line_detection" + ".py"), 
	("區域顏色分析   ", CATEGORY_ITEMS_DICT["vision"], MENU_ITEM_PARENT_PATH + "demo_reginal_color_analyze" + ".py"), 
	("自動學習並追蹤", CATEGORY_ITEMS_DICT["vision"], MENU_ITEM_PARENT_PATH + "demo_learn_track_color" + ".py"), 
	("尋找綠色的物體", CATEGORY_ITEMS_DICT["vision"], MENU_ITEM_PARENT_PATH + "demo_find_color_green" + ".py"),
	("尋找圓圈", CATEGORY_ITEMS_DICT["vision"], MENU_ITEM_PARENT_PATH + "demo_find_circle" + ".py"),
	("尋找矩形", CATEGORY_ITEMS_DICT["vision"], MENU_ITEM_PARENT_PATH + "demo_find_rectangle" + ".py"),
	("尋找線條", CATEGORY_ITEMS_DICT["vision"], MENU_ITEM_PARENT_PATH + "demo_find_lines" + ".py"),
	("尋找二維碼並解碼  ", CATEGORY_ITEMS_DICT["vision"], MENU_ITEM_PARENT_PATH + "demo_find_qr_code_2" + ".py"),
	# Audio & Video
	("音樂頻譜分析", CATEGORY_ITEMS_DICT["audiovideo"], MENU_ITEM_PARENT_PATH + "demo_spectrum_analyze" + ".py"), 
	("播放音樂檔案", CATEGORY_ITEMS_DICT["audiovideo"], MENU_ITEM_PARENT_PATH + "demo_play_music" + ".py"), 
	("語音識別（錄製）", CATEGORY_ITEMS_DICT["audiovideo"], MENU_ITEM_PARENT_PATH + "demo_speech_record" + ".py"),
	("語音識別（執行）", CATEGORY_ITEMS_DICT["audiovideo"], MENU_ITEM_PARENT_PATH + "demo_speech_recognition" + ".py")
...
def draw_ok(type):
	if type == "released":
		...
		display_cjk_string(splash,MENU_ITEM_COORD[6][0]+8,MENU_ITEM_COORD[6][1]+6, "執行     ", font_size=1, color=txt_selected, auto_wrap=False)
	elif type == "pressed":
		splash.draw_rectangle(MENU_ITEM_COORD[6][0],MENU_ITEM_COORD[6][1]+1,50,30,fill=True,color=(26,81,143),thickness=1)
		display_cjk_string(splash,MENU_ITEM_COORD[6][0]+8,MENU_ITEM_COORD[6][1]+6, "執行     ", font_size=1, color=color_splash_theme, auto_wrap=False)
...
while True:
	...
	if (key_state_down == 1 and ksd == 0):
		try:
			draw_ok('pressed')
			draw_run(MENU_CURRENT_SELECT % 6, "running", "執行程式中…")
			...
			import machine
			machine.reset()
			draw_run(MENU_CURRENT_SELECT % 6, "failed", "執行失敗" + str(e))
